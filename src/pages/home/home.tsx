...
export default function Home() {
    ...
    return (
        <div className="flex max-md:flex-col justify-between">
            <div ref={tableRef} className="h-fit flex flex-col w-3/5 max-md:w-full table-auto">
                ...
                </div>
                {
                    data.map((row, index) => (
                        <div
                            ...
                            style={{
                                backgroundColor: index === selectedIndex ? "#323232" : "transparent",
                            }}
                        >
                            <div className="text-neutral-400 flex-1">{row.date}</div>
            ...
            {
                selectedIndex !== null && (
                    <div className="md:w-96 w-full max-md:my-2 h-fit p-4 cursor-default border border-white bg-[#212121] flex flex-col gap-4">
                        <h1 className="text-[#FFDDC0]"># {data[selectedIndex].title}</h1>
                        {
                        ...
                        }
                        {
                            ...
                            <Link to={data[selectedIndex].href} target="_blank" className="flex items-center gap-2">
                                See details
                                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M-8.74228e-08 2L0 -3.49691e-07L2 -2.62268e-07L2 2L4 2L4 4L6 4L6 6L8 6L8 8L6 8L6 10L4 10L4 12L2 12L2 14L-6.11959e-07 14L-5.24537e-07 12L2 12L2 10L4 10L4 8L6 8L6 6L4 6L4 4L2 4L2 2L-8.74228e-08 2Z" fill="white" />
                                </svg>
                            </Link>
                        }
                    </div>
